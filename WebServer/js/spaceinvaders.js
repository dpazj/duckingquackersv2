...
function GameOverState() { 
	 ...
	 if(game.level > bestLvl){
		 bestLvl = game.level;
		 bestNMexicans = game.lives;
	 }else if(game.level == bestLvl){
		 if(game.lives > bestNMexicans){
			 bestNMexicans = game.lives;
		 }
	 }
		
	 $("#hiddenLVL").prop("value",bestLvl);
	 $("#hiddenNumber").prop("value",bestNMexicans);
